...
export default function CTASection({ eyebrow = "Get Started", title, subtitle, primaryAction, secondaryAction }) {
  return (
    <section className="relative overflow-hidden bg-[#0D1120] py-28">
      ...
      <Container className="relative text-center">
        ...
        <h2 className="mx-auto max-w-2xl text-4xl font-black tracking-tight text-white sm:text-5xl">{title}</h2>
        {subtitle && <p className="mx-auto mt-6 max-w-xl text-lg text-slate-400">{subtitle}</p>}
