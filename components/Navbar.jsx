            ...
            {navLinks.map((link) => (
              <li key={link.href}>
                ...
                >
                  ...
                  <span className="absolute left-0 -bottom-0.5 h-px w-0 bg-gradient-to-r from-indigo-400 to-violet-400 transition-all duration-300 group-hover:w-full" />
                </a>
              </li>
            ))}
          </ul>
            ...
            {navLinks.map((link, i) => (
              <li key={link.href}>
                <a
                  ...
                  className="flex items-center justify-between py-3.5 text-sm font-medium text-slate-400 transition-colors duration-200 hover:text-white"
                  style={{
                    borderBottom:
                      i < navLinks.length - 1
