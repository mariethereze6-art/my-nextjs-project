...
function Field({ id, label, type = "text", placeholder, value, onChange, error, autoComplete }) {
  return (
...
export default function Subscribe() {
  ...
  return (
    <section id="subscribe" className="bg-[#0A0F1E] py-28">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-1 flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-500 py-3.5 text-sm font-bold text-white shadow-lg shadow-indigo-500/25 transition-all duration-200 hover:bg-indigo-400 hover:shadow-indigo-400/30 disabled:cursor-not-allowed disabled:opacity-60 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0F1E]"
              >
                {loading ? (
                  <>
